...
import space.nanobreaker.configuration.microservice.user.dto.AuthenticationRequest;
...
public class AuthenticationResource {
    ...
    public Uni<TemplateInstance> register(@Valid @BeanParam RegistrationRequest registrationRequest) {
        return registerUserUseCase.execute(registrationRequest.createRequest())
    ...
    public Uni<Response> authenticate(@Valid @BeanParam AuthenticationRequest authenticationRequest) {
        return authenticateUserUseCase.execute(authenticationRequest.createRequest())
